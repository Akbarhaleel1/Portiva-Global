          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className={`w-full flex items-center justify-center bg-gradient-to-r from-teal-500 to-blue-500 text-white font-medium py-3 px-4 rounded-lg transition-all shadow-lg ${isLoading ? 'opacity-70 cursor-not-allowed' : 'hover:from-teal-600 hover:to-blue-600 hover:shadow-xl'
                  }`}
              >
                {isLoading ? (
                  'Sending...'
