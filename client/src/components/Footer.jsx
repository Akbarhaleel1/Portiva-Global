      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-3xl font-bold bg-gradient-to-r from-teal-400 to-blue-500 bg-clip-text text-transparent">Portiva Global</h3>
              <p className="text-gray-400 mt-2">International Export & Importing Solutions</p>
            </div>
            
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <MapPin className="h-5 w-5 text-teal-400 mt-1 flex-shrink-0" />
                <p className="text-gray-300">123 Global Trade Center, New York, NY 10001, United States</p>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300">info@portivaglobal.com</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <ul className="space-y-3">
                  ...
                  <li><a href="#" className="text-gray-300 hover:text-teal-400 transition-colors">Services</a></li>
                  <li><a href="#" className="text-gray-300 hover:text-teal-400 transition-colors">Our Team</a></li>
                  <li><a href="#" className="text-gray-300 hover:text-teal-400 transition-colors">Portfolio</a></li>
                  <li><a href="#" className="text-gray-300 hover:text-teal-400 transition-colors">Testimonials</a></li>
                </ul>
              </div>
              <div>
                <ul className="space-y-3">
                  <li><a href="#" className="text-gray-300 hover:text-teal-400 transition-colors">FAQ</a></li>
                  <li><a href="#" className="text-gray-300 hover:text-teal-400 transition-colors">Resources</a></li>
        ...
        <div className="mt-16 pt-8 border-t border-gray-800 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-gray-400 mb-4 sm:mb-0">© 2025 Portiva Global. All rights reserved.</p>
