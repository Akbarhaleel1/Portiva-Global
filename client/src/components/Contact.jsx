...
import { Mail, Phone, MapPin, Calendar, Clock, MessageSquare, Share2, ExternalLink } from 'lucide-react';
...
const Contact = () => {
  ...
  const departments = [
    { 
      ...
      email: 'portivaglobalint@gmail.com',
      phone: '+91 99461 80294',
      description: 'For general questions about our company, products, or services'
    },
    { 
      id: 'orders',
      name: 'Orders & Shipping',
      email: 'orders@portivaglobal.com',
      phone: '+91 99461 80294',
      description: 'Questions about your order status, shipping, or delivery timelines'
    },
    { 
      id: 'products',
      name: 'Product Information',
      email: 'products@portivaglobal.com',
      phone: '+91 99461 80294',
      description: 'Detailed information about our spices, teas, and other products'
    },
    { 
      id: 'partnerships',
      name: 'Business Partnerships',
      email: 'partnerships@portivaglobal.com',
      phone: '+91 99461 80294',
      description: 'Explore wholesale and distribution opportunities'
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-500/20 to-blue-500/20 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto mt-14">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-16">
          <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Contact By Department</h2>
            ...
            {departments.map(dept => (
              <div key={dept.id} className={activeTab === dept.id ? 'block' : 'hidden'}>
                <div className="max-w-3xl mx-auto">
                  <h3 className="text-2xl font-semibold text-gray-800 mb-3">{dept.name}</h3>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-lg font-medium text-gray-800">{dept.email}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-lg font-medium text-gray-800">{dept.phone}</p>
                      </div>
                    </div>
                  </div>
                </div>
